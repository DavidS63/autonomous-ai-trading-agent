...
class LLMDecisionHead:
    """
    Uses an OpenAI-compatible endpoint (OpenAI, xAI Grok, OpenRouter, local servers, etc.)
    to critique and improve trade ideas generated by the rules-based layer.
    """
    ...
    def __init__(self):
        ...
        if self.enabled:
            ...
            console.print(f"[green]✓ LLM Decision Head enabled[/] – model={self.model}")
        else:
            self.client = None
